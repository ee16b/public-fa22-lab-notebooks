...
// make sure to change this if you decide to wire your components to a different pin!
#define LEFT_MOTOR                  6
#define LEFT_ENCODER                3
#define RIGHT_MOTOR                 5
#define RIGHT_ENCODER               2

// Arduino has 3 LEDs: LED_BUILTIN (which is already automatically defined), RX_LED, and TX_LED
...
void setup(void) {
  ...
  attachInterrupt(digitalPinToInterrupt(RIGHT_ENCODER), flag_right, RISING);
  attachInterrupt(digitalPinToInterrupt(LEFT_ENCODER), flag_left, RISING);
